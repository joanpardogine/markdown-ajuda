...
describe('MdhHtmlToText', function() {
  ...
  describe('MdhHtmlToText (normal mode)', function() {
    ...
    // Fix for https://github.com/adam-p/markdown-ajuda/issues/104
    ...
    // Busted due to https://github.com/adam-p/markdown-ajuda/issues/104
    ...
    // Test fix for bug https://github.com/adam-p/markdown-ajuda/pull/233
    ...
    // Test fix for bug https://github.com/adam-p/markdown-ajuda/issues/251
    ...
    // Test the fix for bug https://github.com/adam-p/markdown-ajuda/issues/288
    ...
    // Test the fix for bug https://github.com/adam-p/markdown-ajuda/issues/289
  ...
  describe('MdhHtmlToText (check-for-MD mode)', function() {
    ...
    it('should not choke on links', function() {
      ...
      var html = '<a href="http://markdown-ajuda.com">MDH</a>';
      var target = 'MDH';
      expect(check(html)).to.equal(target);
    });

    // Check for fix to https://github.com/adam-p/markdown-ajuda/issues/128
